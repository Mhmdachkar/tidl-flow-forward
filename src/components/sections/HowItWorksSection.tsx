...
export function HowItWorksSection() {
  ...
  return (
    <section
      ref={sectionRef}
      id="how-it-works"
      className="relative h-[100svh] overflow-hidden bg-[#F3C300]"
    >
      {/* ── clinical grid ── */}
      <div
        ...
        <div className="relative flex-1">
          {STEPS.map((s, i) => (
            ...
            >
              ...
              {/* body */}
              <p className="mt-5 max-w-[36ch] text-[0.96rem] leading-relaxed text-black/55">{s.body}</p>
          ...
          <div className="invisible pointer-events-none">
            ...
            <p className="mt-5 text-[0.96rem] leading-relaxed">placeholder</p>
          </div>
        </div>
