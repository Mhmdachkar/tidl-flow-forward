...
function FooterLinkGroup({ title, items }: { title: string; items: readonly FooterItem[] }) {
  return (
    <div className="footer-col min-w-0">
      <p className="tidl-eyebrow mb-3" style={{ color: "#e07b0a" }}>
        {title}
      </p>
...
const SOCIAL_ICONS = (
  <>
    <a href="#" aria-label="Facebook" className="tidl-touch-target social-icon" style={{ color: "#e07b0a" }}>
      <svg viewBox="0 0 24 24" fill="currentColor" className="h-5 w-5">
        <path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3V2Z" />
      </svg>
    </a>
    <a href="#" aria-label="X / Twitter" className="tidl-touch-target social-icon" style={{ color: "#e07b0a" }}>
      <svg viewBox="0 0 24 24" fill="currentColor" className="h-5 w-5">
    ...
    <a href="#" aria-label="Instagram" className="tidl-touch-target social-icon" style={{ color: "#e07b0a" }}>
      <svg viewBox="0 0 24 24" fill="currentColor" className="h-5 w-5">
    ...
    <a href="#" aria-label="TikTok" className="tidl-touch-target social-icon" style={{ color: "#e07b0a" }}>
      <svg viewBox="0 0 24 24" fill="currentColor" className="h-5 w-5">
      ...
      >
        <div className="mx-auto max-w-7xl">
          ...
          <div
            ...
            style={{ background: "linear-gradient(90deg, #e07b0a, rgba(224, 123, 10,0.15), transparent)" }}
          />
        </div>
        ...
        <div className="mx-auto flex max-w-7xl flex-col gap-8 lg:flex-row lg:items-start lg:gap-10">
          ...
          <div
            ...
            style={{
              background: "rgba(224, 123, 10,0.07)",
              borderRadius: "1.25rem",
              border: "1px solid rgba(224, 123, 10,0.25)",
            }}
          >
            <p className="tidl-eyebrow mb-3" style={{ color: "#e07b0a" }}>
              Get started today
