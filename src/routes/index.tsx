...
function Nav() {
  ...
  // Lock page scroll (and pause Lenis) when menu is open
  useEffect(() => {
    if (menuOpen) {
      lockPageScroll();
          ...
          {isAuthenticated && (
            <div className="mt-6">
              <button
                ...
                className="flex items-center gap-2 rounded-xl border border-border/60 bg-white px-3 py-2 text-sm text-muted-foreground transition-colors hover:text-foreground"
              >
