        ...
        >
          <div className="mx-auto flex max-w-6xl items-center justify-between">
            ...
            <div className="flex items-center gap-1 sm:gap-1.5">
              <button
                type="button"
                className={`rounded-full font-medium transition-[background-color,color,border-color,padding,font-size] duration-500 ease-[cubic-bezier(0.22,1,0.36,1)] ${
                  scrolled
              ...
              <button
                ...
                className={`flex items-center justify-center transition-[color,opacity,width,height] duration-500 ease-[cubic-bezier(0.22,1,0.36,1)] hover:opacity-65 ${
...
const CARE_CATEGORIES = [
  { label: "Hormonal balance", highlight: "Hormonal", img: product3 },
  { label: "Metabolic care", highlight: "Metabolic", img: product1 },
  { label: "Recovery science", highlight: "Recovery", img: product2 },
  { label: "Longevity stack", highlight: "Longevity", img: product4 },
] as const;
...
type Card = { img: string; tag: string; name: string; sub: string; price: string; lightProduct?: boolean };
const CARDS: Card[] = [
  ...
  { img: product2, tag: "Daily", name: "TIDL Core", sub: "Foundational longevity", price: "$48", lightProduct: true },
          ...
          {CARDS.map((c, i) => (
            ...
            >
              ...
              <div className="pc-meta mt-3 sm:mt-4 flex items-center justify-between">
                ...
                <span className="text-[11px] sm:text-xs font-medium text-[#A88A00] group-hover:translate-x-1 transition-transform">Start →</span>
              </div>
            </div>
          ))}
        </div>
